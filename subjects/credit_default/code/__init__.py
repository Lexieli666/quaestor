# subjects/credit_default/code/ — the subject itself: the only directory the sandbox copies.
#
...
"""The credit_default subject: feature engineering, the VIF screen and the logistic champion."""
